...
namespace TravelExperts.Models.Migrations
{
    ...
    [Migration("20241210060123_nullable_pref_profilePic")]
    partial class nullable_pref_profilePic
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TravelExpertsData.Models.PackagesProductsSupplier", b =>
                {
                    ...
                    b.HasKey("PackageProductSupplierId")
                        .HasName("PK__Packages__53E8ED99B6BE57CE");
                    ...
                    b.HasIndex(new[] { "PackageId", "ProductSupplierId" }, "UQ__Packages__29CA8E955A633CEC")
                        .IsUnique();
            ...
            modelBuilder.Entity("TravelExpertsData.Models.User", b =>
                {
                    ...
                    b.Property<double>("VirtualWallet")
                        .HasColumnType("float");
